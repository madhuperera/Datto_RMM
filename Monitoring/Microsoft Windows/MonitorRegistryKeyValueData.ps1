...
[String] $SUDF_Value = $ENV:DRMM_SUDF_Value # Ex: Custom20
[String] $SUDF_Registry_Data = $ENV:DRMM_SUDF_Registry_Data # Ex: "New Zealand"
...
{
    Update-OutputOnExit -ExitCode $ExitWithNoError -Results "We found the matching Registry Key, Value and Data." -UDF_Value $SUDF_Value -Registry_Value $SUDF_Registry_Data
}
else
{
